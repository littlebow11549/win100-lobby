...
function DepositPage({ setActiveCat }) {
  ...
  const [custom, setCustom] = useState('10,000');
...
function PersonalInfo({ user, setActiveCat }) {
  ...
  const [dob, setDob] = useState('2008-03-03');
...
export { AccountOverview, DepositPage, WithdrawalPage, SupportPage, RecordTable, PersonalInfo, SecurityCenter, CustomerServicePage };
